        ...
        if download_flag:
            ...
            if QCflag:
                ...
                if config.get('options','retrieve_snicar_params')=='True':
                    ...
                    dust = [[0,0,0,0,0],[10000,0,0,0,0],[50000,0,0,0,0],[100000,0,0,0,0],[300000,0,0,0,0],[500000,0,0,0,0],[800000,0,0,0,0],[1000000,0,0,0,0],[1500000,0,0,0,0]]
                    algae = [[0,0,0,0,0],[10000,0,0,0,0],[50000,0,0,0,0],[100000,0,0,0,0],[300000,0,0,0,0],[500000,0,0,0,0],[800000,0,0,0,0],[1000000,0,0,0,0]]
